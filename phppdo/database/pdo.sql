...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 02:08 PM
...
INSERT INTO `orders` (`orders_id`, `users_id`, `product`, `amount`) VALUES
(3, 14, 'panty', 20),
(4, 15, 'tawas', 10);
...
(7, 'asd', 'asd@hgsas'),
(8, 'asd', 'asd@hgsas'),
(14, 'jiajiajia', 'jiajia@gmailjia'),
(15, 'ashuri', 'ashuri@gmail.com');
...
--
ALTER TABLE `orders`
  MODIFY `orders_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
